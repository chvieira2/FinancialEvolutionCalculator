...
BaseCalculator <- R6Class("BaseCalculator",
                          public = list(
                            initialize = function() {
                            },
...
GeneralCalculator <- R6Class("GeneralCalculator",
...
RentalCalculator <- R6Class("RentalCalculator",
                            inherit = BaseCalculator,
                            public = list(
...
PropertyCalculator <- R6Class("PropertyCalculator",
                              inherit = BaseCalculator,
                              public = list(
...
FinancialBalanceCalculator <- R6Class("FinancialBalanceCalculator",
                                      inherit = BaseCalculator,
                                      public = list(
